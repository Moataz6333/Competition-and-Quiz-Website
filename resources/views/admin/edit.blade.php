          ...
          <div class="create container p-3">
                ...
                <form action="{{route('tests.update',$test->id)}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="testContent">
                        ...
                        <label for="points">Test points</label>
                        
                        <input type="text" name="points" placeholder="Test Points" value="{{$test->points}}" >
                        <label for="time">Test time</label>

                        <input type="text" name="time" placeholder="Test Time (min)" value="{{$test->period}}" >
                        <div class="input-group">
                       ...
                       <div class="input-group">
                        ...
                        <input type="time" name="start" value="{{$test->time}}" >
                       </div>
